...
{
    public class BITicketMedioPorSetor : BaseModel
    {
        public int IdTicketMedioPorSetor { get; set; }
        ...
        public BITicketMedioPorSetor() { }

        public BITicketMedioPorSetor(Empresa empresa,
                                      Unidade unidade,
                                      string descricao,
                                      string ano,
                                      decimal? janeiro,
        ...
        public void Valida()
        {
            ...
            if (Unidade == null)
                throw new Exception("Unidade não pode ser vazio");
        }
    }
}
