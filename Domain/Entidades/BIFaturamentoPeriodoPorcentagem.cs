...
{
    public class BIFaturamentoPeriodoPorcentagem : BaseModel
    {
        public int IdFaturamentoPeriodoPorcentagem { get; set; }
        ...
        public BIFaturamentoPeriodoPorcentagem() { }

        public BIFaturamentoPeriodoPorcentagem(Empresa empresa,
                                         Unidade unidade,
                                         string descricao,
                                         string ano,
                                         decimal? janeiro,
