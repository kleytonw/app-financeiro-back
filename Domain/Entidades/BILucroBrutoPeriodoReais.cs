...
{
    public class BILucroBrutoPeriodoReais : BaseModel
    {
        public int IdLucroBrutoPeriodoReais { get; set; }
        ...
        public BILucroBrutoPeriodoReais() { }

        public BILucroBrutoPeriodoReais(Empresa empresa,
                                         Unidade unidade,
                                         string descricao,
                                         string ano,
                                         decimal? janeiro,
