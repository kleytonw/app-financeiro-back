...
{
    public class BILucroBrutoPeriodoPorcentagemMap : BaseModelMap<BILucroBrutoPeriodoPorcentagem>
    {
        public override void Configure(EntityTypeBuilder<BILucroBrutoPeriodoPorcentagem> builder)
        {
            builder.HasKey(x => x.IdLucroBrutoPeriodoPorcentagem);
