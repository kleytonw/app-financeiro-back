...
{
    public class BINumeroClientesMap : BaseModelMap<BINumeroClientes>
    {
        public override void Configure(EntityTypeBuilder<BINumeroClientes> builder)
        {
            builder.HasKey(x => x.IdNumeroClientes);
