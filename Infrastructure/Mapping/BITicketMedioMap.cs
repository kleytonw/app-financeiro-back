...
{
    public class BITicketMedioMap : BaseModelMap<BITicketMedio>
    {
        public override void Configure(EntityTypeBuilder<BITicketMedio> builder)
        {
            builder.HasKey(x => x.IdTicketMedio);
