...
{
    public class BITicketMedioPorSetorMap : BaseModelMap<BITicketMedioPorSetor>
    {
        public override void Configure(EntityTypeBuilder<BITicketMedioPorSetor> builder)
        {
            builder.HasKey(x => x.IdTicketMedioPorSetor);
