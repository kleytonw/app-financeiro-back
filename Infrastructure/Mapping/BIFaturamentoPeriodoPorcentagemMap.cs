...
{
    public class BIFaturamentoPeriodoPorcentagemMap : BaseModelMap<BIFaturamentoPeriodoPorcentagem>
    {
        public override void Configure(EntityTypeBuilder<BIFaturamentoPeriodoPorcentagem> builder)
        {
            builder.HasKey(x => x.IdFaturamentoPeriodoPorcentagem);
