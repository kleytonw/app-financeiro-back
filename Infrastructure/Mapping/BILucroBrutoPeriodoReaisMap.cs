...
{
    public class BILucroBrutoPeriodoReaisMap : BaseModelMap<BILucroBrutoPeriodoReais>
    {
        public override void Configure(EntityTypeBuilder<BILucroBrutoPeriodoReais> builder)
        {
            builder.HasKey(x => x.IdLucroBrutoPeriodoReais);
