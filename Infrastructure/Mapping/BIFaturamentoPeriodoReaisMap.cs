...
{
    public class BIFaturamentoPeriodoReaisMap : BaseModelMap<BIFaturamentoPeriodoReais>
    {
        public override void Configure(EntityTypeBuilder<BIFaturamentoPeriodoReais> builder)
        {
            builder.HasKey(x => x.IdFaturamentoPeriodoReais);
