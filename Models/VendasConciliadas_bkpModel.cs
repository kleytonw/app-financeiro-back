...
{
    public class VendasConciliadas_bkpRequest
    {
    ...
    public class VendasConciliadas_bkpResponse
    {
        public int IdVendasConciliadas { get; set; }
        public string IdentificadorConciliadora { get; set; }
        public DateTime DataInicial { get; set; }
    ...
    public class PesquisarVendaConciliada_bkpRequest
    {
        public string IdentificadorConciliadora { get; set; }
    ...
    public class VendasConciliadas_bkpRequestModelJson
    {
        public int IdCliente { get; set; }
        public string IdentificadorConciliadora { get; set; }
        public DateTime DataInicial { get; set; }
